...
export default function Voice0verArtistSidebar() {
  ...
  const menuItems = [
    { path: "/Voice-over-Artist", icon: <FaTachometerAlt size={20} />, label: "Dashboard" },
    { path: "/Voice-over-Artist/My-Tasks", icon: <FaTasks size={20} />, label: "My Tasks" },  
    { path: "/Voice-over-Artist/Chats", icon: <FaComments size={20} />, label: "Chats" },  
    { path: "/Voice-over-Artist/Payments", icon: <RiMoneyDollarBoxFill size={20} />, label: "Payments" },    
    { path: "/Voice-over-Artist/Notifications", icon: <FaBell size={20} />, label: "Notifications" },   
    { path: "/Voice-over-Artist/Settings", icon: <FaCog size={20} />, label: "Settings" },
  ];
