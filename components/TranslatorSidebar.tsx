...
export default function TranslatorSidebar() {
  ...
  const menuItems = [
    { path: "/Translator", icon: <FaTachometerAlt size={20} />, label: "Dashboard" },
    { path: "/Translator/My-Tasks", icon: <FaTasks size={20} />, label: "My Tasks" },  
    { path: "/Translator/Chats", icon: <FaComments size={20} />, label: "Chats" },  
    { path: "/Translator/Payments", icon: <RiMoneyDollarBoxFill size={20} />, label: "Payments" },    
    { path: "/Translator/Notifications", icon: <FaBell size={20} />, label: "Notifications" },   
    { path: "/Translator/Settings", icon: <FaCog size={20} />, label: "Settings" },
  ];
