...
export default function AdminSideBar() {
  ...
  const menuItems = [
    { path: "/Admin", icon: <FaTachometerAlt size={20} />, label: "Dashboard" },
    { path: "/Admin/User-Management", icon: <FaUsers size={20} />, label: "User Management" },
    { path: "/Admin/Task-Management", icon: <FaTasks size={20} />, label: "Task Management" },
    { path: "/Admin/Projects", icon: <FaProjectDiagram size={20} />, label: "Project Overview" },
    { path: "/Admin/Reports-Analytics", icon: <FaChartBar size={20} />, label: "Reports And Analytics" },
    { path: "/Admin/Notifications", icon: <FaBell size={20} />, label: "Notifications" },
    { path: "/Admin/Payroll-Commissions", icon: <FaMoneyCheckAlt size={20} />, label: "Payments" },
    { path: "/Admin/Chats", icon: <FaComments size={20} />, label: "Chats" },
